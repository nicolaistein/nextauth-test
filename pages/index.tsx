...
export default function IndexPage()  {
  ...
  const handleButtonClick = async () => {
    ...
    console.log("Getting association token for ");
    ...
    if(session?.user != undefined && !hasCheckedPasskey){
      console.log("User is logged in, calling handleButtonClick")
      handleButtonClick().then(() => {
          console.log("handleButtonClick finished")
      })
    }
  ...
  return (
    <Layout>
      ...
      <p>
        ...
        <a href="https://corbado.com">Corbado</a> for authentication.
      </p>
      {!session?.user && (
      <>
      <p>Log in to add a passkey here!</p>
      </>
      )}
